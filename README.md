...
pixi add dependabot-cli
# for installing globally
pixi global install dependabot-cli
```
...
It is possible to list all of the versions of `dependabot-cli` available on your platform:
...
```
pixi search dependabot-cli --channel conda-forge
```
